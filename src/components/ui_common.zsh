...
draw_controls() {
    ...
    case "$mode" in
        "main")
            ...
            echo -e "${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}  ${UI_COLORS[DIM]}${UI_COLORS[TEXT]}Edit:${UI_COLORS[RESET]}${UI_COLORS[DIM]} Ctrl+A Select All  Ctrl+C Copy  Ctrl+X Cut  Ctrl+V Paste${UI_COLORS[RESET]}      ${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}"
            echo -e "${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}  ${UI_COLORS[DIM]}${UI_COLORS[TEXT]}Navigate:${UI_COLORS[RESET]}${UI_COLORS[DIM]} ← → Char  Ctrl+← → Word  ${UI_COLORS[TEXT]}Modes:${UI_COLORS[RESET]}${UI_COLORS[DIM]} Ctrl+R Repeat  Ctrl+S Symmetry${UI_COLORS[RESET]}${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}"
            echo -e "${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}  ${UI_COLORS[DIM]}${UI_COLORS[TEXT]}Select:${UI_COLORS[RESET]}${UI_COLORS[DIM]} Shift+← → Char  Ctrl+Shift+← → Word${UI_COLORS[RESET]}                        ${UI_COLORS[BORDER]}${BOX[V]}${UI_COLORS[RESET]}"
            ;;
        "pattern_manager")
